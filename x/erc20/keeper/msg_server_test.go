		...
		{ //nolint:dupl
			...
			func() { //nolint:dupl
				...
				suite.app.Erc20Keeper = keeper.NewKeeper(
					...
					suite.app.BankKeeper, mockEVMKeeper, suite.app.StakingKeeper, suite.app.RecoveryKeeper)
		...
		},
		{
			...
			func() {
				...
				suite.app.Erc20Keeper = keeper.NewKeeper(
					suite.app.GetKey("erc20"), suite.app.AppCodec(),
					authtypes.NewModuleAddress(govtypes.ModuleName), suite.app.AccountKeeper,
					mockBankKeeper, suite.app.EvmKeeper, suite.app.StakingKeeper, suite.app.RecoveryKeeper)
